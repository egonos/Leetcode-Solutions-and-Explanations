...
We have to reassign the price values according to the Buy-Sell conditions. (Buying is costly so -price <- price)
For that purpose I've constructed another table with the `stock_name` and the `net_price`.
